...
from app.api.api_v1.common.consts import EXCEPT_PATH_LIST, EXCEPT_PATH_REGEX
from app.api.api_v1.database.conn import db
from app.api.api_v1.database.schema import Users, ApiKeys
from app.api.api_v1.errors import exceptions as ex
from app.api.api_v1.common import config, consts
from app.api.api_v1.errors.exceptions import APIException, SqlFailureEx, APIQueryStringEx

from app.models import UserToken

from app.api.api_v1.utils.date_utils import D
from app.api.api_v1.utils.logger import api_logger
from app.api.api_v1.utils.query_utils import to_dict
        ...
        if url.startswith("/v1/api"):
            ...
            if url.startswith("/api/services"):
                ...
                if "authorization" in headers.keys():
                    ...
                    if "Authorization" not in headers.keys():
                        raise ex.NotAuthorized()
        elif url.startswith("/dev/v1/api"):
            # api 인경우 헤더로 토큰 검사
            if url.startswith("/api/services"):
                qs = str(request.query_params)
                qs_list = qs.split("&")
            ...
            cookies["Authorization"] = "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6MTUsImVtYWlsIjoidXNlckBleGFtcGxlLmNvbSIsIm5hbWUiOm51bGwsInBob25lX251bWJlciI6bnVsbCwicHJvZmlsZV9pbWciOm51bGwsInNuc190eXBlIjpudWxsfQ.HZE1Uf1qJkv6pKyALaNkjqQ_I4BKkkkgD6wEMdTTlgo"
